...
|![Hình ảnh](https://neittien0110.github.io/MCU/assets/ESP32-C3_SuperMini.png)|![footprint](https://github.com/user-attachments/assets/c9cf92de-e616-4de2-a36d-33d345a4b8c9)|![lib](https://github.com/user-attachments/assets/b5bd4ab6-a5d3-4f2e-9807-c8df9c87776f)|[Sử dụng ESP32-C3 Super mini](https://neittien0110.github.io/MCU/ESP32/ESP32-C3_SuperMini.html)| 
|Hình ảnh|Ảnh footprint|Thư viện Footprint|Ghi chú|
...
|--|--|--|--|--|--|
|![sạc có đèn báo và nút bấm](https://github.com/neittien0110/linhkiendientu/assets/8079397/b1e6b720-bc40-4d8d-b745-112071fdaaa4)|Schematic|Footprint|Vào Usb TypeC 5V, cặp lỗ PCB vào/ra pin; **Ra cặp lỗ PCB 5V**; có 4 led chỉ định mức pin; **có nút bấm K tự hàn**; không bảo vệ ngược dòng; Kích thước 4.4mm(H) x 20.3mm (W) x 25.4 mm(26.3 nếu tính cả phần usb thòi ra) (L); 2 lỗ 5V cắm vừa PCB, nhưng 2 lỗ đấu pin thì ko vừa và phải hàn phủ lên pcb. \ [Video](https://youtu.be/mD2fCQCn4aY?si=OcyU8dAayVQjNBef)|Thư viện LCSC|[Shopee](https://shopee.vn/M%C3%B4-%C4%91un-s%E1%BA%A1c-pin-lithium-c%E1%BB%95ng-USB-Type-C-5V-2A-DIY-i.578443443.14279169398)|
|![MH-CD42](https://github.com/neittien0110/linhkiendientu/assets/8079397/c848dfda-a559-4a2f-9240-a1ca9779ec2f)|Schematic|Footprint|3 cặp lỗ PCB để Vào 5V, **Ra 5V**, Pin 4.2V; có 4 led chỉ định mức pin; **có nút bấm K tự hàn**; [Video](https://youtu.be/7wipikQeQaM?si=ZpH4JvTmLkixtUVS)|Thư viện LCSC|[Shopee](https://shopee.vn/B%E1%BA%A3ng-M%E1%BA%A1ch-T%C4%83ng-%C3%81p-DC-5V-2.1A-4.2V-3.7V-lithium-18650-Ch%E1%BA%A5t-L%C6%B0%E1%BB%A3ng-Cao-i.578443443.17381782504)|
|--|--|--|--|--|--|
|Hình ảnh|Schematic|Footprint|Ghi chú|Thư viện LCSC|Mua sắm|
