...
2|![MH-CD42](https://github.com/neittien0110/linhkiendientu/assets/8079397/c848dfda-a559-4a2f-9240-a1ca9779ec2f)|Schematic|Footprint|3 cặp lỗ PCB để Vào 5V, **Ra 5V**, Pin 4.2V; có 4 led chỉ định mức pin; **có nút bấm K tự hàn** <br> công suất vẫn ko đủ để nuôi 1 serve sg90 cho thùng rác <br> Điện áp đầu vào : 4.5~5.5VDC  <br> Dòng sạc : 0~2.1A <br> Dòng xả pin : 0~3.5A <br> Điện áp khi đầy pin: 4.2VDC <br> Hiệu suất : 96% <br> Điện áp đầu ra : 5VDC <br> Dòng áp ra : 0~2.4A <br> Nhiệt độ : -20~85 độ  <br> Kích thước : 16x25mm <br> CÓ 2 PHIÊN BẢN: <br>  + Phiên bản Tiêu Chuẩn: nếu tải nhỏ hơn 50mA, đầu ra (OUT 5V) sẽ bị tắt sau 30 giây: nếu tải lớn hơn 50mA, đầu ra sẽ được bật liên tục. Để bỏ chức năng này cho một số mạch tiết kiệm năng lượng (như Vi điều khiển ở chế độ Sleep) cứ sau chu kỳ <20s ta dùng chân IO kích 1 xung LOW (duy trì 100ms) vào chân Key (tương đương 1 cái nhấn - nhả)...hoặc mua Phiên bản Cải Tiến để tránh mất thời gian.<br>   + **Phiên bản Cải Tiến** : Dù có tải hay không tải thì vẫn luôn xuất ra nguồn 5V.<br> [Video](https://youtu.be/7wipikQeQaM?si=ZpH4JvTmLkixtUVS)|Thư viện LCSC|[Shopee](https://shopee.vn/B%E1%BA%A3ng-M%E1%BA%A1ch-T%C4%83ng-%C3%81p-DC-5V-2.1A-4.2V-3.7V-lithium-18650-Ch%E1%BA%A5t-L%C6%B0%E1%BB%A3ng-Cao-i.578443443.17381782504)|
 |--|--|--|--|--|--|
