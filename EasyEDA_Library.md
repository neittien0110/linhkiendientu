...
|![MH-CD42](https://github.com/neittien0110/linhkiendientu/assets/8079397/c848dfda-a559-4a2f-9240-a1ca9779ec2f)|Schematic|Footprint|3 cặp lỗ PCB để Vào 5V, **Ra 5V**, Pin 4.2V; có 4 led chỉ định mức pin; **có nút bấm K tự hàn**; <span style="color:red"> Tự ngắt điện khi dòng xả thấp nên tự tắt MCU </span>; [Video](https://youtu.be/7wipikQeQaM?si=ZpH4JvTmLkixtUVS)|Thư viện LCSC|[Shopee](https://shopee.vn/B%E1%BA%A3ng-M%E1%BA%A1ch-T%C4%83ng-%C3%81p-DC-5V-2.1A-4.2V-3.7V-lithium-18650-Ch%E1%BA%A5t-L%C6%B0%E1%BB%A3ng-Cao-i.578443443.17381782504)|
|--|--|--|--|--|--|
|Hình ảnh|Schematic|Footprint|Ghi chú|Thư viện LCSC|Mua sắm|
