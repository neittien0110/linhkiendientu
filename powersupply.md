...
- Thông số:
  ...
  - Kích thước mô-đun: 22,3 _ 17 _ 4,2mm
...
- Thông số
  - dành cho pin **3.7v /0.5A** sạc đầy là 4.2v / 18650 . lithium . lipo...
  - dòng sạc 0.5 A
...
- Thông số:
  ...
  - có **nút bấm K** và **pad K tự hàn**
  - công suất vẫn **KHÔNG ĐỦ** để nuôi 1 serve sg90 cho thùng rác
...
- CÓ 2 PHIÊN BẢN:
  ...
  2. **Phiên bản Cải Tiến màu trắng: Dù có tải hay không tải thì vẫn luôn xuất ra nguồn 5V**.
...
- Mô tả:
  ...
  - Điện áp đầu ra: 5V ở dạng type-c và 2 chân pin 2.0mm đấu nối trực tiếp với VBUS và GND của type C. **Vào/ra 2 chiều**
...
- Thông số:
  1. Kích thước nhỏ, chiều dài, chiều rộng và chiều cao chỉ 16 _ 12 _ 4,4mm.
...
- Hướng dẫn:
  ...
  - Theo hệ thống dây nhận dạng (các bộ phận có cùng màu được kết nối vật lý), có thể sử dụng đầu vào cổng C hoặc đầu vào dây. Pin sạc, nếu có nhiều, thì phải đấu song song vì đây là sạc 1S. Dây cần được hàn, và dây không được quá mỏng, nếu không dây sẽ không hoạt động bình thường. -**Không thể đảo ngược pin.**
- Các tính năng:
...
- Thông số:
  ...
  - Điện áp đầu ra: **4.0-27V DC** (Có thể điều chỉnh liên tục, đã test)
